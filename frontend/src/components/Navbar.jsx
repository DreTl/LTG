...
export default function Navbar() {
  ...
  const landingLinks = [
    ...
    { to: '/standings', label: 'Standings' },
    { to: '/best-team', label: 'Team of the Week' },
    { to: '/team-profile', label: 'Team Cards' },
    { to: '/admin/login', label: 'Admin' },
  ];
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        {mobileOpen && (
          <div className="md:hidden pb-4 flex flex-col gap-2">
            ...
            <Link to="/admin/login" className="landing-btn-primary mx-2 mt-2 text-center" onClick={() => setMobileOpen(false)}>
              Get Started
            </Link>
          </div>
        )}
